...
let handleSubmit = () => {
    form.post( route( 'admin.programs.save' ), { preserveState: false } )
}
</script>
                ...
                <div class="card card-body" style="min-height:50vh">
                    <div class="row align-items-center mb-3">
                        <div v-if="id.length > 0" class="col d-flex">
                            ...
                            Unpublish</Link>
                            <Link method="put" :preserve-state="false"
                            ...
                            <template v-if="programs.length">
                                <tr v-for="program in programs" :key="program.id">
                                    ...
                                    <td class="small text-nowrap">
                                        <Link preserve-scroll v-if="program.program_status == 'Published'" class="btn p-0 "
