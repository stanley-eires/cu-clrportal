    ...
    <AuthenticatedLayout :title="title">
        <div class="btn-group btn-group-sm mb-3">
            <div v-if="id.length == 0" class="d-flex">
                ...
                New</Link>
                <div class="dropdown">
                    <button id="my-dropdown" class="btn border me-1 border-primary text-primary "
                        data-bs-toggle="dropdown"><i class="fas fa-ellipsis-h"></i></button>
            ...
            <div v-else>
                <Link method="put" :preserve-state="false" :href="route('admin.courses.bulk-actions')"
                    :data="{ course_status: 'Published', id }" class="btn  me-1 btn-primary "><i
                        ...
                        <template v-if="courses.data.length">
                            <tr v-for="course in courses.data" :key="course.id">
                                ...
                                <td class="small text-nowrap">
                                    <Link preserve-scroll v-if="course.course_status == 'Published'" class="btn p-0 "
                                    ...
                                    <Link preserve-scroll v-else class="btn p-0" :href="route('admin.courses.bulk-actions')"
